...
updated: 2026-09-20T18:42:34Z
---

## Current Test

number: 1
name: HC-2 — one real lesson through the Claude Code plugin and one through the Codex skills
expected: |
  Both lessons complete exactly as before the refactor: the dependency graph is built,
  a quiz is graded, a node is locked, and the transcript is mirrored. One repo import by
  GitHub URL, folded into the same run, returns normally.
