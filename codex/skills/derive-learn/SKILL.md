---
name: derive-learn
description: Teach the learner a topic so it actually locks in and is understood, not just memorized. Two principles (unconditional truths first; make it feel discovered) and one process (warm-up, probe, plan, teach, cumulative quiz). Graded questions go through Derive's quiz tool, which grades them and renders them in the browser companion.
---
